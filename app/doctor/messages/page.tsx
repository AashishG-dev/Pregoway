...
import { Send, User, Search, ArrowLeft, Loader2, MessageSquare } from "lucide-react";
        ...
        <div className="flex h-screen bg-slate-50 border-r border-slate-200">
            ...
            {/* Chat Area */}
             <div className={`flex-1 flex flex-col h-full bg-slate-50 ${!selectedPatientId ? 'hidden md:flex' : 'flex'}`}>
                {selectedPatientId ? (
                    <>
                        <header className="bg-white px-6 py-4 border-b border-slate-200 flex items-center gap-4 shadow-sm z-10">
