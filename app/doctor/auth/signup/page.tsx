                        ...
                        <div className="grid grid-cols-2 gap-4">
                             <div className="col-span-2 space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" required value={name} onChange={e => setName(e.target.value)} className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 outline-none" placeholder="Dr. Jane Doe" />
                                </div>
                            </div>
                            ...
                            <div className="col-span-2 space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="email" required value={email} onChange={e => setEmail(e.target.value)} className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 outline-none" placeholder="work@hospital.com" />
                                </div>
                            </div>
                             ...
                             <div className="col-span-2 space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="password" required value={password} onChange={e => setPassword(e.target.value)} className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 outline-none" placeholder="••••••••" />
                                </div>
                            </div>

                             <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-700">Specialization</label>
                                <input type="text" required value={specialization} onChange={e => setSpecialization(e.target.value)} className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 outline-none" placeholder="e.g. OBGYN" />
                            </div>

                             <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-700">Experience (Yrs)</label>
                                <input type="number" required value={experience} onChange={e => setExperience(e.target.value)} className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 outline-none" placeholder="5" />
                            </div>
                             ...
                             <div className="col-span-2 space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" required value={license} onChange={e => setLicense(e.target.value)} className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 outline-none" placeholder="MCI-12345-X" />
                                </div>
                            </div>
                             <div className="col-span-2 space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" required value={hospital} onChange={e => setHospital(e.target.value)} className="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 outline-none" placeholder="City General Hospital" />
                                </div>
                            </div>
                        </div>
